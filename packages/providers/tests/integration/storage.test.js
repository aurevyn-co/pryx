...
(0, vitest_1.describe)('ProviderStorage', function () {
    var tempDir;
    var configPath;
    var storage;
    (0, vitest_1.beforeEach)(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, promises_1.mkdtemp)((0, path_1.join)((0, os_1.tmpdir)(), 'providers-test-'))];
                case 1:
                    tempDir = _a.sent();
                    configPath = (0, path_1.join)(tempDir, 'providers.json');
                    storage = new storage_js_1.ProviderStorage();
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    (0, vitest_1.describe)('save', function () {
        ...
        (0, vitest_1.it)('should create directory if not exists', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        nestedPath = (0, path_1.join)(tempDir, 'nested', 'deep', 'providers.json');
                        registry = (0, registry_js_1.createRegistry)();
    ...
    (0, vitest_1.describe)('load', function () {
        (0, vitest_1.it)('should load registry from file', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        loaded = _b.sent();
                        (0, vitest_1.expect)(loaded.hasProvider('openai')).toBe(true);
                        (0, vitest_1.expect)((_a = loaded.getProvider('openai')) === null || _a === void 0 ? void 0 : _a.apiKey).toBe('test-key');
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        (0, vitest_1.it)('should throw on invalid JSON', function () { return __awaiter(void 0, void 0, void 0, function () {
            var invalidPath, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        invalidPath = (0, path_1.join)(tempDir, 'invalid.json');
                        return [4 /*yield*/, storage.save(invalidPath, (0, registry_js_1.createRegistry)())];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, Promise.resolve().then(function () { return require('fs/promises'); }).then(function (m) { return m.readFile(invalidPath, 'utf8'); })];
                    case 2:
                        data = _a.sent();
                        return [4 /*yield*/, Promise.resolve().then(function () { return require('fs/promises'); }).then(function (m) { return m.writeFile(invalidPath, 'invalid json'); })];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, (0, vitest_1.expect)(storage.load(invalidPath)).rejects.toThrow()];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
...
(0, vitest_1.describe)('createStorage', function () {
    (0, vitest_1.it)('should create new storage instance', function () {
        ...
        (0, vitest_1.expect)(storage).toBeInstanceOf(storage_js_1.ProviderStorage);
    });
});
