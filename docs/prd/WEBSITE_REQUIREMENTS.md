...
2. **Auth Pages**
   - **Device code flow** (/auth/device)
     ...
     - Call /api/auth/device/activate endpoint
     - Show activation instructions
   - **QR code pairing** (/auth/qr)
     - Show pairing code field
     - Display QR code (generate from pairing code)
     - Call /api/pairing/initiate and /api/pairing/confirm
...
│   │   ├── auth/
│   │   │   ├── device.astro   # Device code login
│   │   │   └── qr.astro       # QR code pairing
│   │   ├── dashboard.astro    # User dashboard
│   │   └── admin.astro        # Super admin
│   ├── components/
│   │   ├── dashboard/
│   │   │   ├── DeviceCard.tsx
│   │   │   └── DeviceList.tsx
...
### pryx.dev (Cloudflare Workers)
1. apps/web/src/pages/index.astro - Landing page
2. apps/web/src/pages/auth/device.astro - Device code login
3. apps/web/src/pages/auth/qr.astro - QR code pairing
4. apps/web/src/pages/dashboard.astro - User dashboard
5. apps/web/src/pages/admin.astro - Super admin
6. apps/web/src/layouts/Layout.astro - Site layout
7. apps/web/src/components/Welcome.astro - Hero section
8. apps/web/src/components/dashboard/DeviceList.tsx - Device list

### Localhost Control Panel
1. apps/control-panel/ - New directory
2. apps/control-panel/src/routes/dashboard.tsx - Main dashboard
3. apps/control-panel/src/routes/settings/providers.tsx - Providers
4. apps/control-panel/src/routes/settings/channels.tsx - Channels
5. apps/control-panel/src/routes/settings/mcp.tsx - MCP servers
6. apps/control-panel/src/routes/settings/skills.tsx - Skills
7. apps/control-panel/src/routes/sessions.tsx - Sessions
8. apps/control-panel/src/components/ChatRoom.tsx - Web chat room
9. apps/control-panel/src/components/LogViewer.tsx - Logs viewer
10. apps/control-panel/src/components/StatusMonitor.tsx - Status monitor
