//! Example: Implementing a custom Memory backend for Pryx
//!
...
// ── Re-define the trait types (in your app, import from pryx::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 Pryx Memory Demo — InMemoryBackend\n");
