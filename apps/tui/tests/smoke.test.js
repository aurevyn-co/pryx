...
(0, bun_test_1.describe)("TUI Smoke Test", function () {
    (0, bun_test_1.test)("App starts and renders without crashing", function () { return __awaiter(void 0, void 0, void 0, function () {
        var proc, exitCode, stderr;
